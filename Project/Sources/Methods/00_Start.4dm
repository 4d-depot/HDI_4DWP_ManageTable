...
Case of 
	...
	Else 
		...
		$options.title:="insert or delete rows and columns\ror know what is selected in a table?"
		
		$options.blog:="blog.4d.com"
		$options.info:="Managing rows and columns in tables"  //ex : "4D View Pro feature"
